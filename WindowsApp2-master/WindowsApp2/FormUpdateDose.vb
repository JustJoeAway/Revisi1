...
Public Class FormUpdateDosen
    ...
    Private Sub btnInput_Click(sender As Object, e As EventArgs) Handles btnInput.Click
        ...
        Else
            ...
            Dim simpan As String = "Update TBL_Dosen Set Nama='" & txtNama.Text & "', Umur='" & txtUmur.Text & "', Jenis_Kelamin='" & txtJenisKelamin.Text & "', Tgl_Lahir='" & tanggal & "', Alamat='" & txtAlamat.Text & "', Agama='" & txtAgama.Text & "', No_HP='" & txtNo_hp.Text & "', Email='" & txtEmail.Text & "' where NIM='" & usernamethis & "' "
